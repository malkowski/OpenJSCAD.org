...
FlatShapeCollection.prototype.solidFromLayers = function (layerIDs, height) {
	var self = this;
	return new CSG.Polygon
	.createFromPoints(self.shapes[layerIDs[0]].attr.points)
	.solidFromSlices({
		numslices: layerIDs.length,
		loop: false,
		callback: function (t, i) {
			...
			return new CSG.Polygon.createFromPoints(self.shapes[id].attr.points)
			.translate([ 0, 0, h ])
		}
	});
};
