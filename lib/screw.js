...
screw.definitions = {
	...
	// Wood6 dimensions have not been vetted yet.
	"Wood6": {
		d1: 7,
		h1: 2.9,
		d2: 3.6,
	...
	// Wood8 dimensions have not been vetted yet.
	"Wood8": {
		d1: 8.2,
		h1: 3.5,
		d2: 4.5,
	...
	// Machine8 dimensions have not been vetted yet.
	"Machine8": {
		d1: 8.7,
		d2: 4.8,
		h1: 3.2,
...
screw.getByName = function (definedName) {
	...
	if (d === undefined) {
		throw "Undefined screw '"+definedName+"'"
	}
